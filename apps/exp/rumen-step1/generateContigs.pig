...
B     = foreach A generate FLATTEN( gov.jgi.meta.pig.aggregate.BLAST($1, '/users/kbhatia/data/EC3.2.1.4.faa')) as (geneid: chararray, b: bag {s:(id: chararray, direction: int, sequence: chararray)});
