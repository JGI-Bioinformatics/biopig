...
-- now the sequences
z = load '/users/kbhatia/data/1433.4.1382.fastq.fasta' using gov.jgi.meta.pig.storage.FastaStorage as (id: chararray, d: int, seq: bytearray);
...
store s into '/users/kbhatia/tutorial/barcode';
