...
register ../biopig/target/biopig.jar 

%default READS '../biopig/src/test/resources/1M.fas'
%default P '10'
%default OUTPUTDIR 'x'
...
L = FOREACH J GENERATE $0 as read1,$1 as read2, flatten(gov.jgi.meta.pig.eval.TNFHammingDistance(data));
